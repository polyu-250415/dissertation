...
class AlignRwN:
    ...
    def screen_nodes(self, case_ids):
        for case_id in case_ids:
            ...
            vq_relations_file = f"{self.vq_path}/{case_id}_relations_vq_evaluation.csv"

            aligned_nodes_file = f"{self.vq_path}/{case_id}_nodes_aligned.csv"
            aligned_relations_file = f"{self.vq_path}/{case_id}_relations_aligned.csv"

            nodes_file = f"{self.unit_path}/{case_id}_nodes.csv"
            relations_file = f"{self.unit_path}/{case_id}_relations.csv"

            filter_nodes_file = f"{self.ea_path}/{case_id}_nodes.csv"
            filter_relations_file = f"{self.ea_path}/{case_id}_relations.csv"
